...
/**
 * Extension that initializes mocks and handles strict stubbings. This extension is the JUnit
 * Jupiter equivalent of our JUnit4 {@link MockitoJUnitRunner}.
 *
 * <p>Example usage:
 *
 ...
 * </code></pre>
 *
 * If you would like to configure the used strictness for the test class, use {@link
 * MockitoSettings}.
 *
 * <pre class="code"><code class="java">
 ...
 * </code></pre>
 *
 * This extension also supports JUnit Jupiter's method parameters. Use parameters for initialization
 * of mocks that you use only in that specific test method. In other words, where you would
 * initialize local mocks in JUnit 4 by calling {@link Mockito#mock(Class)}, use the method
 * parameter. This is especially beneficial when initializing a mock with generics, as you no longer
 * get a warning about "Unchecked assignment". Please refer to JUnit Jupiter's documentation to
 * learn when method parameters are useful.
 *
 * <pre class="code"><code class="java">
 * <b>&#064;ExtendWith(MockitoExtension.class)</b>
 * public class ExampleTest {
 ...
 * </code></pre>
 *
 * Lastly, the extension supports JUnit Jupiter's constructor parameters. This allows you to do
 * setup work in the constructor and set your fields to <code>final</code>. Please refer to JUnit
 * Jupiter's documentation to learn when constructor parameters are useful.
 *
 * <pre class="code"><code class="java">
 * <b>&#064;ExtendWith(MockitoExtension.class)</b>
 * public class ExampleTest {
...
public class MockitoExtension implements BeforeEachCallback, AfterEachCallback, ParameterResolver {
  ...
  private MockitoExtension(Strictness strictness) {
    ...
    this.parameterResolver =
        new CompositeParameterResolver(new MockParameterResolver(), new CaptorParameterResolver());
  }
